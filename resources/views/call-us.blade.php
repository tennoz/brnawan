...
<body>
    ...
    <section class="contact-us text-center" id="contact">
        <div class="fields">
            <div class="container">
                <div class="row"> <i class="fa fa-headphones fa-5x"></i>
                    <h1>نحن ف انتظارك مكالمتك</h1>
                    <p class="lead">مستعدون لإتصالك ف اى وقت</p>
                    <!--                start contact form-->
                    <form method="post">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control input-lg" type="text" placeholder="الإسم"> </div>
                            <div class="form-group">
                                <input class="form-control input-lg" type="text" placeholder="البريد الإلكترونى"> </div>
                            <div class="form-group">
                                <input class="form-control input-lg" type="text" placeholder="رقم الهاتف"> </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea class="form-control input-lg" placeholder="رسالتك"></textarea>
                            </div>
                            <button type="button" class="btn-block input-lg">راسلنا</button>
                        </div>
                    </form>
                </div>
            </div>
