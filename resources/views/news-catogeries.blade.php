...
<body>
    ...
    <div class="news">
        <div class="container">
            <div class="new">
                <h3><i class="fa fa-newspaper-o"></i> أخر أخبار الجمعية</h3>
                <div class="new-item">
                    <div class="row">
                        <div class="col-md-2"><img class="center-block img-responsive" src="images/logo.png" alt=""></div>
                        <div class="col-md-10">
                            <h5>
                                <i class="fa fa-calendar"></i> أغسطس 13, 2017

                            </h5>
                            <p>
                                قامت جمعية البر الخيرية يالإشتراك مع بعض الجمعيات لمساعدة المرضى فى مستشفة النور
                            </p>
