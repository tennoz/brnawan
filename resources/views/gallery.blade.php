...
<body>
    ...
    <div class="gallery text-center">
        <div class="container">
            <h1>معرض الصور </h1>
            <div class="row">
                <div class="works col-md-3">
                    <a href="images/gallery/1.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/1.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/2.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/2.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/3.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/3.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/4.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/4.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/5.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/5.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/6.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/6.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/7.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/7.png" alt=""></a>
                </div>
                <div class="works col-md-3">
                    <a href="images/gallery/8.png" data-lightbox="roadtrip"> <div class="over">show more</div><img src="images/gallery/8.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bank-section">
        <div class="container">
                ...
                <div class="col-xs-12 col-md-6">
                    <img src="images/bank1.png" class="img-responsive center-block">
                </div>
        </div>
    </div>
    <!--end bank-->
